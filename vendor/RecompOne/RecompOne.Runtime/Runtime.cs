...
public static class Runtime
{
    ...
    static string MemoryCardPath(string environmentName, string fallback) {
    ...
    public static Hardware.MemoryCard CardA = new(
        MemoryCardPath("RECOMPONE_CARD_A_PATH", "carda.sav")) { Enabled = true };
    public static Hardware.MemoryCard CardB = new(
        MemoryCardPath("RECOMPONE_CARD_B_PATH", "cardb.sav")) { Enabled = true };
