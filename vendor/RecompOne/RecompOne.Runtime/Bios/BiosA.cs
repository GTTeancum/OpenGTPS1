        ...
        switch (fn)
        {
            ...
            case 0x3A:
                throw new InvalidOperationException(
                    $"BIOS _exit({c.A0}) called; ra=0x{c.RA:X8} " +
                    $"sp=0x{c.SP:X8} a1=0x{c.A1:X8}");
            ...
            case 0xAB:
                Log.Bios($"_card_info port=0x{c.A0:X8}");
                BiosB.QueueCardInfo(c.A0);
                c.V0 = 1u;
                break;
            case 0xAC: BiosB.QueueCardInfo(c.A0); c.V0 = 1u; break;
