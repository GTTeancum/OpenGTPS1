...
OpenGTPS1 0.8beta supports only the US Gran Turismo 2 **Simulation Disc**,
`SCUS-94488`, NTSC-U revision 2. The Arcade Disc, other regions, and earlier
US revisions are not supported.
...
- Bounded crash-hunt coverage across five World League tracks, multiple
  vehicles, purchases, upgrades, results, and replays with zero known
  legitimate unmapped calls remaining.
